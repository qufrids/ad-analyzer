...
function Overline({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-[11px] font-semibold tracking-[0.15em] uppercase text-zinc-500 mb-4">
      {children}
    </p>
  );
}
    ...
    <div className="min-h-screen bg-[#09090B] text-white overflow-x-hidden">
      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, #22C55E 0%, transparent 70%)",
          }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_480px] gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal delay={0.18} className="w-full">
              <div className="relative">
                ...
                <div className="relative bg-zinc-900 border border-white/[0.08] rounded-2xl overflow-hidden shadow-2xl shadow-black/60">
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <p className="text-[9px] font-semibold tracking-[0.15em] uppercase text-zinc-500 mb-2">
                          Performance Score
                        </p>
                      ...
                      <div className="text-right">
                        <div className="px-3 py-2 bg-green-500/[0.08] border border-green-500/[0.15] rounded-xl">
                          <p className="text-[9px] font-semibold tracking-[0.12em] uppercase text-zinc-500">
                            Est. CTR
                          </p>
                    ...
                    <div className="bg-zinc-800/60 border border-white/[0.05] rounded-xl h-[88px] flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="absolute bottom-2 left-2.5">
                        <span className="text-[9px] font-semibold text-zinc-600 bg-zinc-800/80 px-1.5 py-0.5 rounded uppercase tracking-wider">
                          Sponsored
                        </span>
                      </div>
                    ...
                    <div className="bg-zinc-800/50 border border-white/[0.05] rounded-xl p-3.5">
                      ...
                      <p className="text-[12px] text-zinc-300 leading-relaxed">
                        Headline is strong. Tighten the CTA from &ldquo;Learn More&rdquo; to a
                        specific outcome — could push CTR above 4%.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-24 sm:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-16 lg:gap-24 items-start">
            ...
            {/* Right: pain points as editorial list */}
              ...
              {[
                {
                  ...
                  body:
                    "Creative decisions rely on intuition. There is no data. The team debates, picks one, launches — and prays.",
                },
                {
                  num: "02",
                  title: "Discovering failure after you've spent",
                  body:
                    "Most performance marketers find out a creative is weak after $2,000–$10,000 in test spend. Too late.",
                },
                {
                  num: "03",
                  title: "Slow testing cycles killing momentum",
                  body:
                    "Each failed creative costs 5–14 days. At agency scale, that compounds into months of wasted velocity.",
                },
                {
                  num: "04",
                  title: "Scaling without confidence",
                  body:
                    "Scaling an unvalidated creative is a gamble. The budget multiplies, and so does the risk of a dud.",
                },
              ].map((p, i) => (
              ...
              <div className="bg-zinc-900 border border-white/[0.07] rounded-xl overflow-hidden h-full">
                ...
                <div className="p-5 space-y-5">
                  ...
                  <div className="pt-4 border-t border-white/[0.05] grid grid-cols-3 text-center gap-2">
                    {[{ label: "Est. CTR", val: "0.7%", red: true }, { label: "Hook", val: "Weak", red: true }, { label: "Confidence", val: "Low", red: true }].map((s) => (
                      <div key={s.label}>
              ...
              <div className="bg-zinc-900 border border-green-500/[0.18] rounded-xl overflow-hidden h-full relative">
                ...
                <div className="px-5 py-3.5 border-b border-green-500/[0.08] flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="px-1.5 py-0.5 text-[9px] font-black text-green-400 bg-green-500/10 border border-green-500/20 rounded uppercase tracking-widest">
                      Winner
                    </span>
                  </div>
                ...
                <div className="bg-zinc-900 border border-white/[0.07] rounded-xl p-7 h-full hover:border-white/[0.12] transition-colors flex flex-col">
                  ...
                  <div className="flex gap-1 mb-5">
                    {Array.from({ length: 5 }).map((_, s) => (
                      <svg key={s} className="w-3.5 h-3.5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="p-7 flex-1 flex flex-col">
                    ...
                    <p
                      className={`text-[12px] mb-7 ${
                        p.highlight ? "text-zinc-500" : "text-zinc-600"
                      }`}
                    >
                      {p.desc}
                    </p>
              ...
              <ScrollReveal key={faq.q} delay={i * 0.04}>
                <details className="group py-5">
                  <summary className="flex items-center justify-between gap-4 cursor-pointer list-none">
                    ...
                    <svg
                      className="w-4 h-4 text-zinc-600 shrink-0 group-open:rotate-180 transition-transform duration-200"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <section className="py-24 sm:py-36 border-t border-white/[0.05]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-x-0 top-1/2 -translate-y-1/2 h-64 opacity-[0.035]"
