...
function ScoreCircle({ score, color }: { score: number; color: string }) {
  ...
  return (
    <svg width="52" height="52" viewBox="0 0 36 36">
      ...
      />
      <text x="18" y="21.5" textAnchor="middle" fill={color} fontSize="8" fontWeight="800">
        {score}
      </text>
    </svg>
  );
...
export default function BeforeAfter() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      {/* Before card */}
      <div className="bg-white border border-[#E2E8F0] rounded-[16px] p-8 relative" style={{ borderTop: "2px solid #EF4444" }}>
        ...
        <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-4 mb-5">
          <div className="w-full h-24 bg-[#E2E8F0] rounded-lg flex items-center justify-center mb-3">
      ...
      {/* After card */}
      <div className="bg-white border border-[#E2E8F0] rounded-[16px] p-8 relative" style={{ borderTop: "2px solid #16A34A" }}>
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-bold text-white bg-[#16A34A] px-2.5 py-1 rounded-full uppercase">
              WINNER
            </span>
          </div>
        ...
        {/* Mock ad */}
        <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-4 mb-5">
          <div className="w-full h-24 bg-gradient-to-br from-[#EEF2FF] to-[#F0FDF4] rounded-lg flex items-center justify-center mb-3">
